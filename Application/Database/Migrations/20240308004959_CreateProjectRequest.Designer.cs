...
namespace YoungDeveloper.Application.Database.Migrations
{
    ...
    [Migration("20240308004959_CreateProjectRequest")]
    partial class CreateProjectRequest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YoungDeveloper.Application.Models.ProjectRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_project_requests");

                    b.HasIndex("ProjectId")
                        .HasDatabaseName("ix_project_requests_project_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_project_requests_user_id");
            ...
            modelBuilder.Entity("YoungDeveloper.Application.Models.ProjectRequest", b =>
                {
                    b.HasOne("YoungDeveloper.Application.Models.Project", "Project")
                        .WithMany("ProjectRequests")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_requests_projects_project_id");
                    ...
                    b.HasOne("YoungDeveloper.Application.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_project_requests_users_user_id");
